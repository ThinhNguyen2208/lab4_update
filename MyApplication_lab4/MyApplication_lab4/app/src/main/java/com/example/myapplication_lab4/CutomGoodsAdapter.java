...
public class CutomGoodsAdapter extends BaseAdapter {
    public CutomGoodsAdapter(Context ctx, int layoutItem, ArrayList<Goods> arrayList) {
        this.ctx = ctx;
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        imgGoods.setImageResource(arrayList.get(i).getImagesGoods());
        return view;
    }
}
